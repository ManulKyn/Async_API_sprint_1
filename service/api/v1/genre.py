...
from services.genres import get_genre_service, GenreService
...
#     genre = await genre_service.genre_detail(genre_id)#тут надо добавить детальный поиск в эластике в service\services\genres.py
#     if not genre:
